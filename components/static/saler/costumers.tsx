...
export const Costumers = () => {
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full p-3 border-2 text-black border-[#E8F4FE] rounded-xl focus:outline-none focus:border-[#6FBDF5]"
              />
            </div>
            <div>
  ...
  return (
    <div className="mr-0 md:mr-12 pb-12 overflow-x-auto" dir="rtl">
      <div className="flex justify-start mr-12  gap-4 mb-6">
        <motion.button
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
          onClick={() => setActiveTab("list")}
          className={`px-6 py-3 rounded-xl text-black transition-colors ${
